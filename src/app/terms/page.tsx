      ...
      <main className="flex-1 max-w-4xl mx-auto px-6 py-16 flex flex-col gap-8 animate-fadeIn">
        ...
        <div className="flex flex-col gap-6 text-zinc-650 text-xs leading-relaxed font-medium">
          <section className="flex flex-col gap-2">
            <h2 className="text-sm font-extrabold text-zinc-900">1. Acceptance of Terms</h2>
            <p>
          ...
          <section className="flex flex-col gap-2">
            <h2 className="text-sm font-extrabold text-zinc-900">2. Description of Service</h2>
            <p>
          ...
          <section className="flex flex-col gap-2">
            <h2 className="text-sm font-extrabold text-zinc-900">3. Instagram Account Security & Meta Compliance</h2>
            <p>
          ...
          <section className="flex flex-col gap-2">
            <h2 className="text-sm font-extrabold text-zinc-900">4. Subscriptions, Quotas, and Billing</h2>
            <p>
          ...
          <section className="flex flex-col gap-2">
            <h2 className="text-sm font-extrabold text-zinc-900">5. Prohibited Activities</h2>
            <p>
          ...
          <section className="flex flex-col gap-2">
            <h2 className="text-sm font-extrabold text-zinc-900">6. Limitation of Liability</h2>
            <p>
          ...
          <section className="flex flex-col gap-2">
            <h2 className="text-sm font-extrabold text-zinc-900">7. Contact & Support</h2>
            <p>
      ...
      <footer className="border-t border-zinc-200 bg-white py-8 mt-auto shadow-inner">
        <div className="max-w-7xl mx-auto px-6 flex flex-col sm:flex-row items-center justify-between gap-4 text-zinc-500 text-xs font-semibold">
          ...
          <div className="flex items-center gap-6">
            <Link href="/terms" className="hover:text-purple-650 transition text-purple-650">Terms of Service</Link>

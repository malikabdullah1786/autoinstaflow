      ...
      <main className="flex-1 max-w-4xl mx-auto px-6 py-16 flex flex-col gap-8">
        ...
        <div className="flex flex-col gap-6 text-zinc-350 text-xs leading-relaxed font-medium">
          <section className="flex flex-col gap-2">
            ...
            <ul className="list-disc pl-5 flex flex-col gap-1.5 mt-1 text-zinc-400">
          ...
          <section className="flex flex-col gap-2">
            <h2 className="text-sm font-extrabold text-white">3. Data Security & Storage</h2>
            <p>
          ...
          <section className="flex flex-col gap-2">
            <h2 className="text-sm font-extrabold text-white">4. User Rights & Data Deletion</h2>
            <p>
          ...
          <section className="flex flex-col gap-2">
            <h2 className="text-sm font-extrabold text-white">5. Cookie Policy</h2>
            <p>
          ...
          <section className="flex flex-col gap-2">
            <h2 className="text-sm font-extrabold text-white">6. Inquiries and Contacts</h2>
            <p>
      ...
      <footer className="border-t border-zinc-900 bg-zinc-950/20 py-8 mt-auto">
        <div className="max-w-7xl mx-auto px-6 flex flex-col sm:flex-row items-center justify-between gap-4 text-zinc-500 text-xs font-semibold">
          ...
          <div className="flex items-center gap-6">
            ...
            <Link href="/privacy" className="hover:text-purple-450 transition text-white">Privacy Policy</Link>

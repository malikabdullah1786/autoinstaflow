...
export default function DocsPage() {
  ...
  return (
    <div className="min-h-screen bg-[#09090b] text-zinc-100 font-sans selection:bg-purple-500 selection:text-white relative overflow-hidden">
      ...
      <div className="absolute bottom-10 right-1/4 w-96 h-96 bg-pink-600/10 rounded-full blur-[100px] pointer-events-none" />
      ...
      <header className="sticky top-0 z-40 bg-[#09090b]/80 backdrop-blur-md border-b border-zinc-800/80 px-6 py-4 flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          <Link href="/api-reference" className="text-xs font-semibold text-zinc-400 hover:text-white transition flex items-center gap-1.5">
        ...
        <aside className="w-64 shrink-0 hidden md:block sticky top-28 h-[calc(100vh-140px)] overflow-y-auto pr-2">
          ...
          <div className="relative mb-6">
            ...
            <input
              ...
              className="w-full bg-zinc-900/50 border border-zinc-800/80 rounded-xl py-2 pl-10 pr-4 text-xs focus:outline-none focus:border-purple-500 transition placeholder:text-zinc-500"
            />
          </div>
          ...
          <nav className="flex flex-col gap-6">
            {sections.map((section) => (
              <div key={section.id} className="flex flex-col gap-1.5">
                <div className="flex items-center gap-2 px-2 text-xs font-bold text-zinc-400 uppercase tracking-wider">
                  {section.icon}
                  <span>{section.title}</span>
                </div>
                <div className="flex flex-col gap-0.5 border-l border-zinc-800/60 ml-4 pl-3.5 mt-1">
                  {section.items.map((item) => (
                    <button
                      key={item.id}
                      onClick={() => handleScrollTo(item.id)}
                      className={`text-left text-xs py-1.5 hover:text-white transition-colors duration-150 relative ${
        ...
        <main className="flex-1 max-w-4xl overflow-y-auto">
          ...
          <section id="introduction" className="mb-16 scroll-mt-24">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h2 className="text-2xl font-extrabold text-white">Introduction</h2>
            </div>
            <div className="prose prose-invert prose-sm text-zinc-450 leading-relaxed space-y-4">
              <p>
              ...
              <div className="p-4 rounded-xl bg-purple-950/20 border border-purple-900/40 text-xs text-purple-300 flex items-start gap-3">
                <Sparkles className="w-5 h-5 text-purple-400 shrink-0 mt-0.5" />
                <div>
                  <strong className="font-bold text-purple-200">Pro Tip:</strong> We recommend building a dedicated keyword flow like <code>"SEND"</code> or <code>"LINK"</code> on your highest performing reels to immediately see a 10x lift in conversion compared to traditional link-in-bio setups.
                </div>
              </div>
            </div>
          </section>
          ...
          <section id="installation" className="mb-16 scroll-mt-24">
            ...
            <div className="prose prose-invert prose-sm text-zinc-450 leading-relaxed space-y-4">
              ...
              <ol className="list-decimal list-inside space-y-3 pl-2">
                <li>
                  <strong className="text-zinc-200">Sign in with Google:</strong> Authenticate instantly without passwords. We generate a default workspace automatically upon your first login.
                </li>
                <li>
                  <strong className="text-zinc-200">Configure Workspace:</strong> Workspaces separate different clients, accounts, or brands. Isolate all analytics, contacts, and workflows cleanly.
                </li>
                <li>
                  <strong className="text-zinc-200">Select Subscription:</strong> Check your current plan capabilities. Gated features, contact exports, and advanced analytics require a <strong>Pro</strong> or <strong>Growth</strong> tier.
                </li>
              </ol>
            </div>
          </section>
          ...
          <section id="linking" className="mb-16 scroll-mt-24">
            <h3 className="text-xl font-bold text-white mb-4">Linking Instagram Accounts</h3>
            <div className="prose prose-invert prose-sm text-zinc-450 leading-relaxed space-y-4">
              <p>
                To enable automation, link your Instagram business profile to your workspace via Facebook Login.
              </p>
              <div className="p-4 bg-zinc-900/50 border border-zinc-800 rounded-xl flex flex-col gap-3">
                <span className="text-xs font-bold text-zinc-300">OAuth Connection Requirements:</span>
                <ul className="list-disc list-inside text-xs text-zinc-450 space-y-1.5 pl-2">
                  <li>Your Instagram account must be converted to a <strong className="text-zinc-300">Creator</strong> or <strong className="text-zinc-300">Business</strong> account.</li>
                  <li>The Instagram account must be linked to an active <strong className="text-zinc-300">Facebook Page</strong> that you admin.</li>
          ...
          <section id="triggers" className="mb-16 scroll-mt-24">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h2 className="text-2xl font-extrabold text-white">Triggers & Keywords</h2>
            </div>
            <div className="prose prose-invert prose-sm text-zinc-450 leading-relaxed space-y-4">
              <p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 my-6">
                <div className="p-4 bg-zinc-900/40 border border-zinc-800/80 rounded-xl">
                  <span className="text-xs font-bold text-zinc-200 block mb-1">Comment Triggers</span>
                  <p className="text-xs text-zinc-450">Fires when someone comments on a selected post or reel. You can restrict this to specific keywords.</p>
                </div>
                <div className="p-4 bg-zinc-900/40 border border-zinc-800/80 rounded-xl">
                  <span className="text-xs font-bold text-zinc-200 block mb-1">Story Replies</span>
                  <p className="text-xs text-zinc-450">Triggers when a follower replies to or reacts with emojis to a live active story (within the 24-hour window).</p>
                </div>
                <div className="p-4 bg-zinc-900/40 border border-zinc-800/80 rounded-xl">
                  <span className="text-xs font-bold text-zinc-200 block mb-1">Direct Messages</span>
                  <p className="text-xs text-zinc-450">Activates on incoming direct messages containing your specified keywords.</p>
                </div>
              </div>
              <h4 className="text-sm font-extrabold text-zinc-200">Keyword Matching Logic</h4>
              <p>
                Keyword matching is <strong className="text-pink-400">case-insensitive</strong>. For example, if you set the keyword trigger to <code>"promo"</code>, comment terms like <code>"PROMO!"</code> or <code>"Promo code please"</code> will successfully trigger the automation. You can set multiple keywords per automation. If no keywords are configured, the trigger fires on *every* comment/reaction.
              </p>
            </div>
          </section>

          <section id="actions" className="mb-16 scroll-mt-24">
            <h3 className="text-xl font-bold text-white mb-4">Actions & Responses</h3>
            <div className="prose prose-invert prose-sm text-zinc-450 leading-relaxed space-y-4">
              <p>
              ...
              <table className="min-w-full text-xs text-left border-collapse my-6">
                <thead>
                  <tr className="border-b border-zinc-800 text-zinc-350 font-bold bg-zinc-900/30">
                ...
                <tbody className="divide-y divide-zinc-800/60">
                  <tr>
                    <td className="py-2.5 px-3 font-semibold text-zinc-200">Send DM with Link</td>
                    <td className="py-2.5 px-3">Sends the recipient a direct message with text and a custom clickable URL.</td>
                    <td className="py-2.5 px-3 text-zinc-400">All Plans</td>
                  </tr>
                  <tr>
                    <td className="py-2.5 px-3 font-semibold text-zinc-200">Follow Gate</td>
                    <td className="py-2.5 px-3">Checks if the user follows your profile. If not, sends a follow prompt before sending the link.</td>
                    <td className="py-2.5 px-3 text-purple-400">Pro, Growth</td>
                  </tr>
                  <tr>
                    <td className="py-2.5 px-3 font-semibold text-zinc-200">Email Gate</td>
              ...
              <div className="p-4 rounded-xl bg-zinc-950 border border-zinc-800 text-xs leading-relaxed space-y-2">
                <span className="font-bold text-zinc-200 block">Deduplication Protection:</span>
                <p>
                  To prevent spam, Auto Insta Flow incorporates built-in rate safeguards. The platform will not trigger the same automation for the same Instagram account multiple times within a <strong className="text-zinc-200">24-hour window</strong>.
                </p>
              </div>
            </div>
          </section>
          ...
          <section id="templates" className="mb-16 scroll-mt-24">
            <h3 className="text-xl font-bold text-white mb-4">Using Templates</h3>
            <div className="prose prose-invert prose-sm text-zinc-450 leading-relaxed space-y-4">
              <p>
                Our Template Library includes 18 pre-built templates organized by operational objectives:
              </p>
              <ul className="list-disc list-inside space-y-1.5 pl-2">
                <li><strong className="text-zinc-200">Sell & Earn:</strong> Affiliate Links, Discount Codes, Product Promos.</li>
                <li><strong className="text-zinc-200">Capture Leads:</strong> Deliver Lead Magnets, Collect Emails First, Grow Waitlists.</li>
                <li><strong className="text-zinc-200">Engage Audience:</strong> Thank Story Reactors, Thank Commenters, Start Conversations.</li>
              </ul>
              <p>
          ...
          <section id="follow-gate" className="mb-16 scroll-mt-24">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h2 className="text-2xl font-extrabold text-white">Gated Engagement</h2>
            </div>
            <h3 className="text-xl font-bold text-white mb-3">Follow Gate</h3>
            <div className="prose prose-invert prose-sm text-zinc-450 leading-relaxed space-y-4">
              <p>
          ...
          <section id="email-gate" className="mb-16 scroll-mt-24">
            <h3 className="text-xl font-bold text-white mb-4">Email Gate</h3>
            <div className="prose prose-invert prose-sm text-zinc-450 leading-relaxed space-y-4">
              <p>
          ...
          <section id="contacts" className="mb-16 scroll-mt-24">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h2 className="text-2xl font-extrabold text-white">Workspace & Contacts Management</h2>
            </div>
            <h3 className="text-xl font-bold text-white mb-3">Managing Contacts</h3>
            <div className="prose prose-invert prose-sm text-zinc-450 leading-relaxed space-y-4">
              <p>
          ...
          <section id="analytics-tracking" className="mb-16 scroll-mt-24">
            <h3 className="text-xl font-bold text-white mb-4">CTR & Performance Metrics</h3>
            <div className="prose prose-invert prose-sm text-zinc-450 leading-relaxed space-y-4">
              <p>
                Auto Insta Flow tracks performance analytics automatically:
              </p>
              <ul className="list-disc list-inside space-y-2 pl-2">
                <li><strong className="text-zinc-200">DMs Sent:</strong> The total number of direct messages sent out.</li>
                <li><strong className="text-zinc-200">Link Clicks:</strong> Number of clicks registered on custom automation URLs.</li>
                <li><strong className="text-zinc-200">CTR (Click-Through Rate):</strong> Calculated as <code>(Link Clicks / DMs Sent) * 100</code>. A higher CTR indicates engaging content copy and high-intent landing pages.</li>
              </ul>
            </div>
          </section>

          <section id="limits-billing" className="mb-16 scroll-mt-24">
            <h3 className="text-xl font-bold text-white mb-4">Limits & Quotas</h3>
            <div className="prose prose-invert prose-sm text-zinc-450 leading-relaxed space-y-4">
              <p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 my-4">
                <div className="p-4 rounded-xl bg-zinc-900 border border-zinc-800 text-center">
                  <span className="text-xs font-bold text-zinc-400 block mb-1">Free Plan</span>
                  <span className="text-lg font-black text-white">500 DMs</span>
                  <span className="text-[10px] text-zinc-500 block mt-1">/ month</span>
                </div>
                <div className="p-4 rounded-xl bg-zinc-900 border border-zinc-800 text-center">
                  <span className="text-xs font-bold text-purple-400 block mb-1">Pro Plan</span>
                  <span className="text-lg font-black text-white">5,000 DMs</span>
                  <span className="text-[10px] text-zinc-500 block mt-1">/ month</span>
                </div>
                <div className="p-4 rounded-xl bg-zinc-900 border border-zinc-800 text-center">
                  <span className="text-xs font-bold text-pink-400 block mb-1">Growth Plan</span>
                  <span className="text-lg font-black text-white">10,000 DMs</span>
                  <span className="text-[10px] text-zinc-500 block mt-1">/ month</span>
                </div>
              </div>
              <p>
